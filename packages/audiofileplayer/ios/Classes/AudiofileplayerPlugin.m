...
static NSString *const kAudioCategoryPlayAndRecord = @"iosAudioCategoryPlayAndRecord";
...
- (void)handleMethodCall:(FlutterMethodCall *)call result:(FlutterResult)result {
    ...
    if ([call.method isEqualToString:kLoadMethod]) {
        ...
        if ([categoryString isEqualToString:kAudioCategoryPlayAndRecord]) {
        ...
        } else if ([categoryString isEqualToString:kAudioCategoryPlayback]) {
